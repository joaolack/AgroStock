    ...
    <header class="sticky top-0 z-20 flex items-center justify-between border-b bg-white/85 px-5 py-3.5 backdrop-blur-md sm:px-6"
        ...
        <div class="flex min-w-0 items-center gap-3">
            ...
            <div class="min-w-0">
                ...
                <h1 class="truncate text-xl font-bold tracking-tight sm:text-2xl" style="color:#1a3d1f;">Editar fornecedor</h1>
            </div>
        </div>
    ...
    <div class="flex-1 overflow-y-auto p-4 sm:p-6">
        <div class="mx-auto grid max-w-7xl gap-5 xl:grid-cols-[minmax(0,1fr)_360px]">
            <main class="overflow-hidden rounded-2xl border bg-white shadow-sm"
                    ...
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                        <div class="max-w-2xl">
                            ...
                            <p class="mt-2 max-w-xl text-sm leading-6" style="color:#6e876f;">
                                Atualize contato, endere&ccedil;o, status e observa&ccedil;&otilde;es internas deste fornecedor.
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-3 overflow-hidden rounded-xl border bg-white text-center"
                            ...
                            <div class="px-4 py-3">
                                ...
                                <p class="mt-1 text-lg font-bold" style="color:#1a3d1f;">#{{ $supplier->id }}</p>
                            </div>
                            ...
                            <div class="px-4 py-3">
                                ...
                                <p class="mt-1 text-lg font-bold" style="color:#1a3d1f;">{{ $supplier->active ? 'Ativo' : 'Inativo' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="px-5 py-6 sm:px-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="mt-5 space-y-5">
                            <div>
                                ...
                                <textarea id="notes" name="notes" rows="4"
                                    ...
                                    placeholder="Informa&ccedil;&otilde;es adicionais sobre o fornecedor...">{{ old('notes', $supplier->notes) }}</textarea>
                ...
                <div class="overflow-hidden rounded-2xl border text-white shadow-sm"
                    ...
                    <div class="p-5">
                        <div class="flex items-start justify-between gap-4">
                            <div class="min-w-0">
                                <p class="text-[11px] font-bold uppercase tracking-[0.22em]" style="color:rgba(255,255,255,0.55);">Fornecedor em edi&ccedil;&atilde;o</p>
                                <h2 class="mt-3 break-words text-2xl font-bold leading-tight">{{ $supplier->name }}</h2>
                            </div>
                        ...
                        <div class="mt-8 grid grid-cols-2 gap-3">
                            <div class="rounded-xl border p-3" style="border-color:rgba(255,255,255,0.12);background:rgba(255,255,255,0.06);">
                                <p class="text-[10px] font-bold uppercase tracking-[0.16em]" style="color:rgba(255,255,255,0.48);">Cidade/UF</p>
                            ...
                            <div class="rounded-xl border p-3" style="border-color:rgba(255,255,255,0.12);background:rgba(255,255,255,0.06);">
                                ...
                                <p class="mt-2 text-lg font-bold">{{ $supplier->active ? 'Ativo' : 'Inativo' }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="border-t px-5 py-4 text-sm" style="border-color:rgba(255,255,255,0.12);color:rgba(255,255,255,0.7);">
                        Esta tela atualiza os dados do fornecedor sem alterar produtos j&aacute; cadastrados.
                    </div>
                </div>
                ...
                <div class="rounded-2xl border bg-white p-5 shadow-sm" style="border-color:#d4e8d6;">
                    ...
                    <div class="mt-4 space-y-3">
                        <div class="flex items-center gap-3 rounded-xl border px-3 py-3" style="border-color:#edf4ee;background:#fbfdfb;">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-slate-900">Contato atualizado</p>
                        ...
                        <div class="flex items-center gap-3 rounded-xl border px-3 py-3" style="border-color:#edf4ee;background:#fbfdfb;">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-slate-900">Endere&ccedil;o conferido</p>
                        ...
                        <div class="flex items-center gap-3 rounded-xl border px-3 py-3" style="border-color:#edf4ee;background:#fbfdfb;">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-slate-900">Status validado</p>
                                <p class="text-xs text-slate-500">Controle se pode ser usado em produtos</p>
                            </div>
                        </div>
                    </div>
                </div>
