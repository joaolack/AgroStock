...
<div class="flex min-h-screen flex-1 flex-col overflow-hidden">
    <header class="sticky top-0 z-20 flex items-center justify-between border-b bg-white/80 px-6 py-3.5 backdrop-blur-md"
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="font-display text-xl font-bold tracking-tight" style="color:#1a3d1f;">Novo Fornecedor</h1>
                <p class="text-[11px]" style="color:#8a9e8c;">Cadastre um novo fornecedor para vincular aos produtos</p>
            </div>
        </div>
